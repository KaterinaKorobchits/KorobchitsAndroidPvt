...
object Dz11StudentsStorage {
    ...
    private fun fillList() {
        listStudents = mutableListOf(
            Dz6Student(
                ...
                "100005",
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvWddTef4q0yfqEV_f_AfVfkrkMEE67IwwXLblS2HTRRfzhSPr",
                "Paulina LuckyDog",
                3
            ), Dz6Student(
    ...
    fun addStudent(student: Dz6Student) {
        val index = listStudents.indexOfFirst { it.id == student.id }
    ...
    fun removeStudent(idStudent: String) {
        listStudents.find { it.id == idStudent }?.apply { listStudents.remove(this) }
    }
